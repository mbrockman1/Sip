...
class HydrationManager: NSObject, ObservableObject, WCSessionDelegate {
    ...
    @Published var baseGoalML: Double = 2000 { didSet { Constants.defaults.set(baseGoalML, forKey: "baseGoalML") } }
    ...
    @Published var useAdaptiveGoals: Bool = false { didSet { Constants.defaults.set(useAdaptiveGoals, forKey: "useAdaptiveGoals"); if useAdaptiveGoals { Task { await refreshAdaptiveGoal() } } else { resetGoalToBase() } } }
...
//import WeatherKit
//import CoreLocation
//import WatchConnectivity // 🌟 Preserved Watch Fix
//
//// MARK: - Data Models
//
//struct DailyIntake: Identifiable {
...
//            ensureActivityRunning(forceUpdate: true)
//            pushStateToWatch() // 🌟 Preserved Watch Fix
//        }
//    }
...
//
//    override init() {
//        super.init() // 🌟 Required for NSObject/WatchConnectivity
//        reloadFromDefaults()
//        currentStreak = StreakManager.computeStreak()
//        checkMidnightReset()
//        ensureActivityRunning()
...
//    }
//    
//    // MARK: - Watch Sync Logic (Replaces PhoneSessionManager)
//    
//    func pushStateToWatch() {
//        if WCSession.isSupported() && WCSession.default.activationState == .activated {
//            do {
...
//             Task { @MainActor in
//                 
//                 self.todaysSamples = samples.reversed() // 🌟 Save newest-first for the History View
//                 
//                 var simLevel: Double = 0
//                 var simTime = startOfDay
//                 for sample in samples {
...
//         healthStore.delete(sample) { success, _ in
//             if success {
//                 Task { @MainActor in self.syncFromHealthKit() } // Recalculates everything!
//             }
//         }
//     }
//
...
//        }
//        
//        self.pushStateToWatch() // 🌟 Preserved Watch Fix
//    }
//
//    private func handleGoalAchieved() {
//        StreakManager.recordGoalHit()
